...
public class BookingService(IBookingRepo bookingRepo, IResourceRepo resourceRepo) : IBookingService
{
    ...
    private static BookingDto ToDto(Booking book)
    {
        return new BookingDto(
            Id: book.Id, BookedBy: book.BookedBy, EndTime: book.EndTime, Purpose: book.Purpose, StartTime: book.StartTime, ResourceId: book.ResourceId, Resource: book.Resource?.Name, IsCancelled: book.IsCancelled
        )
        { };
    }
